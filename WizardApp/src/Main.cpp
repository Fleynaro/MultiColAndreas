...
void doWork(std::string gamePath, std::string outputPath, bool SAMPObjs, bool CustomObjs, bool vehicles)
{
	BuildManager *thisBuild = new BuildManager(gamePath, outputPath, SAMPObjs, CustomObjs, vehicles);
